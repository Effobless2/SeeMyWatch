...
import { StyleSheet, Text, TextInput, View , TouchableOpacity, Image, StatusBar, Button} from 'react-native';
...
render() {
    return (
        <View style={styles.container}>
          ...
          onPress={() =>Passerelle.Custom(this.state.favSize, this.state.favMatiere, this.state.favColor, this.state.favColor)}
        />
        </View>
